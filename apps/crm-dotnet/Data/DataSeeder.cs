...
namespace AspCrm.Data
{
    public static class DataSeeder
    {
        ...
        public static async Task SeedAsync(IServiceProvider services)
        {
            ...
            for (var attempt = 1; attempt <= retries; attempt++)
            {
                try
                {
                    ...
                    await EnsureShopUsersTableAsync(context);
                    break;
                }
        ...
        private static async Task EnsureShopUsersTableAsync(AppDbContext context)
        {
            const string sql = """
                CREATE TABLE IF NOT EXISTS "ShopUsers" (
                    ...
                    CONSTRAINT "FK_ShopUsers_Customers_CustomerId"
                        FOREIGN KEY ("CustomerId") REFERENCES "Customers" ("Id") ON DELETE RESTRICT
                );

                CREATE UNIQUE INDEX IF NOT EXISTS "UX_ShopUsers_Email"
                    ON "ShopUsers" ("Email");
                """;
